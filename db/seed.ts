...
const ROLE_PERMISSIONS_MAPPING: Record<string, string[]> = {
  ...
  // MODERATEUR : Modération membres + contenu (permissions complètes de gestion membres)
  Moderateur: [
    "events:read",
    "resources:read", "resources:validate",
    "members:read", "members:update", "members:ban", "members:change_role", "members:delete",
    "logs:read",
    "tasks:read", "tasks:create", "tasks:update", "tasks:delete",
    "feedback:read", "feedback:create",
  ],
